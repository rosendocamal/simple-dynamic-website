			<footer>
				<p class="website-credits">Sitio web creado por Rosendo Camal</p>
				<ul class="contact-means">
					<li class="contact contact-github">
						<a class="contact-link my-account" href="https://github.com/rosendocamal/">
					...
					<li class="contact contact-linkedin">
						<a class="contact-link my-account" href="https://www.linkedin.com/in/rosendo-c">
					...
					<li class="contact contact-facebook">
						<a class="contact-link my-account" href="https://www.facebook.com/people/Rosendo-Camal/100073097972725/">
					...
					<li class="contact contact-instagram">
						<a class="contact-link my-account" href="https://www.instagram.com/rosendocamal/">
